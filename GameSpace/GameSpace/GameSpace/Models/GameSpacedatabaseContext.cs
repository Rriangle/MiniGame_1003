...
public partial class GameSpacedatabaseContext : DbContext
{
    ...
    public virtual DbSet<ManagerAccountRole> ManagerAccountRoles { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<ManagerDatum>(entity =>
        {
            ...
            entity.HasMany(d => d.ManagerRoles).WithMany(p => p.Managers)
                .UsingEntity<ManagerAccountRole>(
                    j => j.HasOne(ar => ar.Role).WithMany(r => r.ManagerAccountRoles)
                        .HasForeignKey(ar => ar.ManagerRoleId)
                        .OnDelete(DeleteBehavior.Cascade)
                        .HasConstraintName("FK_ManagerAccountRole_ManagerRolePermission"),
                    j => j.HasOne(ar => ar.Manager).WithMany(m => m.ManagerAccountRoles)
                        .HasForeignKey(ar => ar.ManagerId)
                        .OnDelete(DeleteBehavior.Cascade)
                        .HasConstraintName("FK_ManagerAccountRole_ManagerDatum"),
                    j =>
                    {
                        j.HasKey(ar => new { ar.ManagerId, ar.ManagerRoleId }).HasName("PK_ManagerAccountRole");
                        j.ToTable("ManagerRole");
                        j.Property(ar => ar.ManagerId).HasColumnName("Manager_Id");
                        j.Property(ar => ar.ManagerRoleId).HasColumnName("ManagerRole_Id");
                    });
        });
        ...
        {
            entity.HasKey(e => new { e.ManagerId, e.ManagerRoleId }).HasName("PK_ManagerAccountRole");
            ...
            entity.HasOne(d => d.Manager).WithMany(p => p.ManagerAccountRoles)
                .HasForeignKey(d => d.ManagerId)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("FK_ManagerAccountRole_ManagerDatum");

            entity.HasOne(d => d.Role).WithMany(p => p.ManagerAccountRoles)
        ...
        modelBuilder.Entity<MiniGame>(entity =>
        {
            ...
            entity.HasOne(d => d.User).WithMany(p => p.GamePlayRecords)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<GameSpace.Areas.MiniGame.Models.ViewModels.PetInteractionBonusRules>(entity =>
        {
            ...
            entity.Property(e => e.MinBonus).HasColumnName("MinBonus");
            entity.Property(e => e.MaxBonus).HasColumnName("MaxBonus");
            entity.Property(e => e.PointsCost).HasColumnName("PointsCost");
            entity.Property(e => e.CooldownMinutes).HasColumnName("CooldownMinutes");
            entity.Property(e => e.ExpReward).HasColumnName("ExpReward");
        ...
        modelBuilder.Entity<GameSpace.Areas.MiniGame.Models.Settings.PetSkinColorPointSettings>(entity =>
        {
            entity.HasKey(e => e.SettingId);

            entity.ToTable("PetSkinColorPointSettings");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK_SignInRule");

            entity.ToTable("SignInRule");

            entity.HasIndex(e => e.SignInDay, "IX_SignInRule_SignInDay")
                .HasFilter("([IsActive] = 1)");

            entity.HasIndex(e => e.IsActive, "IX_SignInRule_IsActive");

            entity.Property(e => e.Id).HasColumnName("Id");
            entity.Property(e => e.SignInDay).HasColumnName("SignInDay");
            entity.Property(e => e.Points).HasColumnName("Points");
            entity.Property(e => e.Experience).HasColumnName("Experience");
            entity.Property(e => e.HasCoupon).HasColumnName("HasCoupon");
            ...
            // 種子資料
            entity.HasData(
                new SignInRule { Id = 1, SignInDay = 1, Points = 10, Experience = 5, HasCoupon = false, IsActive = true, CreatedAt = new DateTime(2025, 10, 8, 0, 0, 0, DateTimeKind.Utc), Description = "第一天簽到獎勵" },
                new SignInRule { Id = 2, SignInDay = 2, Points = 10, Experience = 5, HasCoupon = false, IsActive = true, CreatedAt = new DateTime(2025, 10, 8, 0, 0, 0, DateTimeKind.Utc), Description = "第二天簽到獎勵" },
                new SignInRule { Id = 3, SignInDay = 3, Points = 15, Experience = 8, HasCoupon = false, IsActive = true, CreatedAt = new DateTime(2025, 10, 8, 0, 0, 0, DateTimeKind.Utc), Description = "第三天簽到獎勵" },
                new SignInRule { Id = 4, SignInDay = 4, Points = 15, Experience = 8, HasCoupon = false, IsActive = true, CreatedAt = new DateTime(2025, 10, 8, 0, 0, 0, DateTimeKind.Utc), Description = "第四天簽到獎勵" },
                new SignInRule { Id = 5, SignInDay = 5, Points = 20, Experience = 10, HasCoupon = false, IsActive = true, CreatedAt = new DateTime(2025, 10, 8, 0, 0, 0, DateTimeKind.Utc), Description = "第五天簽到獎勵" },
                new SignInRule { Id = 6, SignInDay = 6, Points = 20, Experience = 10, HasCoupon = false, IsActive = true, CreatedAt = new DateTime(2025, 10, 8, 0, 0, 0, DateTimeKind.Utc), Description = "第六天簽到獎勵" },
                new SignInRule { Id = 7, SignInDay = 7, Points = 30, Experience = 15, HasCoupon = true, CouponTypeCode = "WEEK_BONUS", IsActive = true, CreatedAt = new DateTime(2025, 10, 8, 0, 0, 0, DateTimeKind.Utc), Description = "第七天簽到獎勵 + 週獎勵優惠券" },
                new SignInRule { Id = 8, SignInDay = 14, Points = 50, Experience = 25, HasCoupon = true, CouponTypeCode = "TWO_WEEK_BONUS", IsActive = true, CreatedAt = new DateTime(2025, 10, 8, 0, 0, 0, DateTimeKind.Utc), Description = "連續簽到 14 天獎勵" },
                new SignInRule { Id = 9, SignInDay = 21, Points = 80, Experience = 40, HasCoupon = true, CouponTypeCode = "THREE_WEEK_BONUS", IsActive = true, CreatedAt = new DateTime(2025, 10, 8, 0, 0, 0, DateTimeKind.Utc), Description = "連續簽到 21 天獎勵" },
                new SignInRule { Id = 10, SignInDay = 30, Points = 150, Experience = 75, HasCoupon = true, CouponTypeCode = "MONTH_BONUS", IsActive = true, CreatedAt = new DateTime(2025, 10, 8, 0, 0, 0, DateTimeKind.Utc), Description = "連續簽到 30 天獎勵（滿月獎勵）" }
            );
        });
